...
var script = {
  ...
  methods: {
    ...
    arrowModifier: function arrowModifier(dataObject, options) {
    ...
    convertPos: function convertPos(pos, popper, reference, arrowElement) {
      var type = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 'left';
      var pos1 = '';
      ...
      if (typeof pos === 'number') {
        if (this.arrowPosition === 'start') {
          ...
          pos1 = Math.min(reference[len], popper[len]) - Math.min(0, popper[altSide] - reference[altSide]) - this.arrowOffset - arrowElement[offsetLen];
...
var VuePopper = normalizeComponent_1({
