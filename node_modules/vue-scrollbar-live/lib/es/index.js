      ...
      handler: function handler(val) {
        ...
        setTimeout(function () {
          ...
          if (val && typeof window !== 'undefined') {
            _this.unbind = DragMove.bind(_this.$refs.bar, _this.drag);
          }
        }, 200);
      },
      immediate: true
...
var script$1 = {
  ...
  computed: {
    ...
    $_wrapStyle: function $_wrapStyle() {
      return {
        position: 'relative',
        height: this.isMobile ? 'auto !important' : "".concat(this.height.wrap, "px !important"),
  ...
  methods: {
    getHeight: function getHeight() {
      ...
      var fn = function fn() {
        if (_this3.$refs.content) {
          var _this3$$refs$content = _this3.$refs.content,
              scrollHeight = _this3$$refs$content.scrollHeight,
              clientHeight = _this3$$refs$content.clientHeight,
              scrollWidth = _this3$$refs$content.scrollWidth,
              clientWidth = _this3$$refs$content.clientWidth;
          _this3.height.content = clientHeight;
          _this3.height.contentInner = scrollHeight;
          _this3.height.parent = _this3.$refs.wrap.parentElement.clientHeight;
          _this3.width.content = clientWidth;
          _this3.width.contentInner = scrollWidth;
          _this3.width.parent = _this3.$refs.wrap.parentElement.clientWidth;
        }
      };
    ...
    scroll: function scroll() {
      var _this$$refs$content = this.$refs.content,
          ...
          scrollLeft = _this$$refs$content.scrollLeft;
      this.setScroll({
        scrollTop: scrollTop,
    ...
    setScroll: function setScroll(_ref) {
      var _ref$scrollTop = _ref.scrollTop,
          scrollTop = _ref$scrollTop === void 0 ? undefined : _ref$scrollTop,
          _ref$scrollLeft = _ref.scrollLeft,
          scrollLeft = _ref$scrollLeft === void 0 ? undefined : _ref$scrollLeft;
    ...
    bind: function bind() {
      this.$once('hook:beforeDestroy', Utils.$addListener(this.$refs.content, 'scroll', this.scroll));
    },
  ...
  created: function created() {
    ...
    if (!this.isMobile && typeof window !== 'undefined') {
      ...
      this.$once('hook:mounted', function () {
        _this4.nativeScrollbarWidth = getNativeScrollbarWidth(_this4.$refs.content);
